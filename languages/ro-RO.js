...
module.exports = class extends Language {
    ...
    constructor(...args) {
        super(...args);
        this.language = {
            DEFAULT: key => `${key} inca nu a fost localizata pentru ro-RO.`,
            INHIBITOR_DISABLED: "<:penguError:435712890884849664> ***Aceasta comanda este deactivata la moment.***",
            INHIBITOR_DISABLED_GROUP: "<:penguError:435712890884849664> ***Acest grup de comenzi este deactivat.***",
            COMMAND_UNLOAD: (type, name) => `<:penguSuccess:435712876506775553> Descarcat ${type}: ${name}`,
            COMMAND_TRANSFER_ERROR: "<:penguError:435712890884849664> Acest fisier a fost deja transferat sau nu exista.",
            COMMAND_RELOAD: (type, name) => `<:penguSuccess:435712876506775553> Incarcat ${type}: ${name}`,
            COMMAND_RELOAD_ALL: type => `<:penguSuccess:435712876506775553> Reincarcat toate ${type}.`,
            COMMAND_LOAD: (time, type, name) => `<:penguSuccess:435712876506775553> S-a incarcat cu success ${type}: ${name}. (A luat: ${time})`,
            COMMAND_LOAD_ERROR: (type, name, error) => `<:penguError:435712890884849664> A esuat sa se incarce ${type}: ${name}. Motiv:${util.codeBlock("js", error)}`,
            COMMAND_INVITE: `**👉 | Invita PenguBot la server-ul vostru:** <https://www.PenguBot.com/invite>`,
            COMMAND_SUPPORT: `**__Support guild pentru PenguBot__**\n• **Link de Invitatie:** https://discord.gg/u8WYw5r`,
            COMMAND_INVITE_DESCRIPTION: "Afiseaza link-ul de intrare a server-ului",
            COMMAND_INFO: [
                "PenguBot este un bot cu multe folosuri plin cu comenzi variind de la ",
                "Moderatie, Distractie, Utilitate si mai multe. Este dezvoltat in NodeJS folosind ",
                "tehnologii de tipul RethinkDB, JavaScript and Linux.",
                "",
                "• **Autor:** [AdityaTD#5346](https://www.AdityaTD.me)",
                `• **Versiune:** ${require("../package").version}`,
                "• **Site Web:** <https://www.PenguBot.com>",
